...
public class HomeFragment extends Fragment {
    ...
    private void updateTableItems(String stringDate, String stringMealNumber) {
        ...
        for (int x = 0; x < intCursorFdCount; x++) {
            ...
            if (stringMealNumber.equals("0")) {
                tl = getActivity().findViewById(R.id.tableLayoutBreakfastItems); /* Find Tablelayout defined in main.xml */
            } else if (stringMealNumber.equals("1")) {
                tl = getActivity().findViewById(R.id.tableLayoutLunchItems); /* Find Tablelayout defined in main.xml */
            } else if (stringMealNumber.equals("2")) {
                tl = getActivity().findViewById(R.id.tableLayoutBeforeTrainingItems); /* Find Tablelayout defined in main.xml */
            } else if (stringMealNumber.equals("3")) {
                tl = getActivity().findViewById(R.id.tableLayoutAfterTrainingItems); /* Find Tablelayout defined in main.xml */
            } else if (stringMealNumber.equals("4")) {
                tl = getActivity().findViewById(R.id.tableLayoutDinnerItems); /* Find Tablelayout defined in main.xml */
            } else if (stringMealNumber.equals("5")) {
                tl = getActivity().findViewById(R.id.tableLayoutSnacksItems); /* Find Tablelayout defined in main.xml */
            } else {
                tl = getActivity().findViewById(R.id.tableLayoutSupperItems); /* Find Tablelayout defined in main.xml */
            }
    ...
    public void editTextPortionSizePcsOnChange() {
        if (!(lockPortionSizeByGram)) {
            ...
            EditText editTextPortionSizeGram = getActivity().findViewById(R.id.editTextServingSizeGram);
    ...
    public void calcualteNumberOfCalEatenToday(String stringDate) {
        ...
        TextView textViewBodyRemaining = getActivity().findViewById(R.id.textViewBodyRemaining);
